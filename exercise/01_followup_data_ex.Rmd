...
In this tutorial, we will learn some tools and tricks in analysing follow-up data using two by two contingency tables. This kind of data are typically collected from a cohort study or randomised controlled trials.  
...
To get ready for computing person-days at risk, we need to turn `dat_ue_1` into this form:
...
> A useful trick: In RStudio, view the dataset by clicking on the dataframe name in your script file while pressing Control key on your keyboard.   
