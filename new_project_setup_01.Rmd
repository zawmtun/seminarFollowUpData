...
3. Create a folder structure. Edit the structure as necessary.
...
4. Create a README file and add title and other relevant details
...
Copy and paste the following to `README.md`
